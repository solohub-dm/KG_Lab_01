...
class Point {
  ...
  unitVector(ePoint) {
    ...
    return new Point((ePoint.x - this.x) / len, (ePoint.y - this.y) / len);
  }
  midlVector(oPoint) {
...
class Rectangle {
  constructor(lStartPoint, lEndPoint, sStartPoint, sEndPoint) {
...
class Coords {
  constructor(lStartPoint, lEndPoint) {
    this.lStartPoint = lStartPoint;
    this.lEndPoint = lEndPoint;
...
class Properties {
  constructor(colorFill = "transparent", colorLine = "transparent") {
...
class Dimensions {
  constructor(largerLen, heightLen, smallerLenMax) {
...
class Trapezium {
  ...
  setCoords(sStartPoint, sEndPoint, h1Point, h2Point, smallerLen, offset) {
  ...
  getLStartPoint() {
    return this.coords.lStartPoint;
  }
  getLEndPoint() {
    return this.coords.lEndPoint;
  }
  getSStartPoint() {
    return this.coords.sStartPoint;
  }
  getSEndPoint() {
    return this.coords.sEndPoint;
  }
  getH1Point() {
    return this.coords.h1Point;
  }
  getH2Point() {
    return this.coords.h2Point;
  }
  getVecH() {
    return this.vector.vecH;
  }
  getVecV() {
    return this.vector.vecV;
  }
  getLargerLen() {
    return this.dimens.largerLen;
  }
  getHeightLen() {
    return this.dimens.heightLen;
  }
  getSmallerLenMax() {
    return this.dimens.smallerLenMax;
  }
  getOffset() {
    return this.dimens.offset;
  }
}
